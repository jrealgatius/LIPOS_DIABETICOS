...
fitxer_output<-"TAULES_LIPOS_global.Rdata"
...
T1.5<-Pvalors_ajustats_compare(T1.3,metodo = "bonferroni",p="p.mul")
...
extreure_coef_glm(dt=dades,outcomes="lipos2",x="HbA1c",z="",taulavariables="VARIABLES.xls")

taula_coef_hb<-extreure_coef_glm(dt=dades,outcomes="lipos2",x="HbA1c",z="age.sex.ajust",taulavariables="VARIABLES.xls")

taula_coef<-taula_coef_hb[[1]]

TAULA_HB_Lipos<-Pvalors_ajustats_taula(objecte_taula=taula_coef, p.valors='Pr(>|t|)', metodo="bonferroni")
